...
declare module '@wetoria/siyuan-sdk' {
    interface SiYuanAPI extends AccountAPI, AIAPI, ArchiveAPI, AssetAPI, AttrAPI, AvAPI, BazaarAPI, BlockAPI, BookmarkAPI, BroadcastAPI, ClipboardAPI, CloudAPI, ConvertAPI, ExportAPI, ExtensionAPI, FileAPI, FileTreeAPI, FormatAPI, GraphAPI, HistoryAPI, IconAPI, ImportAPI, InboxAPI, LuteAPI, NetworkAPI, NotebookAPI, NotificationAPI, OutlineAPI, PetalAPI, QueryAPI, RefAPI, RepoAPI, RiffAPI, SearchAPI, SettingAPI, SnippetAPI, SqliteAPI, StorageAPI, SyncAPI, SystemAPI, TagAPI, TemplateAPI, TransactionsAPI, UIAPI {
    }
}
